...
urlpatterns = [
    ...
    path('add_product_box/',
         views.add_product_on_boxes, name='add_product_box'),
    ...
    path('editproductonbox/<int:pk>/',
         views.edit_product_on_box, name='editproductonbox'),
    path('deleteproduct/<int:pk>/',
         views.delete_product, name='delete_product'),
    path('deleteproductonbox/<int:pk>/',
         views.delete_productonbox, name='deleteproductonbox'),
    path('boxes_list/', ListBoxes.as_view(), name='boxes_list'),
    path('products_list/', ListProducts.as_view(), name='products_list'),
    path('productsonbox_list/',
         ListProductsOnBox.as_view(), name='productsonbox_list'),
]
